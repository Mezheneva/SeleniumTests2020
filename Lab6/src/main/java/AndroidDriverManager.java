...
public class AndroidDriverManager {
    ...
    protected void startService() {
        ...
        builder.withAppiumJS(new File(
                "C:\\Users\\Irina\\AppData\\Local\\Programs\\Appium\\resources\\app\\node_modules\\appium\\build\\lib\\main.js"));
        builder.withArgument(GeneralServerFlag.LOG_LEVEL, "error");
        AppiumDriverLocalService appiumDriverLocal = builder.build();
        AndroidDriverManager.appiumDriverLocalService = appiumDriverLocal;
    ...
    protected void createDriver() {
        ...
        capabilities.setCapability("deviceName", "A5_Pro");
